(function () {
  ...
  const SUPPORTED = ["en-US", "en-AU", "fr", "es", "pt", "ru"];
  ...
  const translations = {
    ...
    ru: {
      ...
      Add: "Добавить",
      Docs: "Документы",
      "Manual Add": "Ручной ввод",
      Manual: "Руководство",
      Admin: "Админ",
      "Last Assylum: Plague Violation Tracker": "Last Assylum: трекер нарушений чумы",
      "Quarantine ledger": "Карантинный журнал",
      "Upload battle report": "Загрузить боевой отчет",
      "Upload covert ops image": "Загрузить скрин тайной операции",
      "Upload caravan attack": "Загрузить атаку каравана",
      Image: "Изображение",
      "Server ID": "ID сервера",
      "Server ID filter": "Фильтр ID сервера",
      "Default year": "Год по умолчанию",
      "Victim alliance": "Альянс жертвы",
      "Process battle image": "Обработать бой",
      "Process ops image": "Обработать операцию",
      "Process caravan image": "Обработать караван",
      "Recent attacks": "Недавние атаки",
      ID: "ID",
      Attack: "Атака",
      Type: "Тип",
      Attacker: "Атакующий",
      ...
      Delete: "Удалить",
      Source: "Источник",
      "Submitted image": "Отправленное изображение",
      ...
      Attackers: "Атакующие",
      Targets: "Цели",
      "Who they attack": "Кого атакуют",
      "Who attacks them": "Кто атакует их",
      Enemies: "Враги",
      "Members Hit": "Затронутые участники",
      "Members seen in reports": "Участники в отчетах",
      Name: "Имя",
      "Attacks Made": "Совершено атак",
      "Attacks Received": "Получено атак",
      Total: "Итого",
      "Recent alliance activity": "Недавняя активность альянса",
      Role: "Роль",
      "Alliance activity": "Активность альянсов",
      "Alliance ledger": "Журнал альянсов",
      "Attacking Members": "Атакующие участники",
      "Total Activity": "Общая активность",
      "Alliance vs alliance": "Альянс против альянса",
      "Add attack manually": "Добавить атаку вручную",
      "Attacker name": "Имя атакующего",
      "Attacker alliance tag": "Тег альянса атакующего",
      "Defender name": "Имя защитника",
      "Defender alliance tag": "Тег альянса защитника",
      "Date/time text": "Текст даты/времени",
      Save: "Сохранить",
      "Search players": "Поиск игроков",
      "Search by name": "Поиск по имени",
      Search: "Поиск",
      "Total Events": "Всего событий",
      "Attack history": "История атак",
      "Other party": "Другая сторона",
      "Server stats": "Статистика сервера",
      "Attack types over time": "Типы атак по времени",
      "Daily attack volume by type, filtered by attacking alliance or attacking player.": "Ежедневный объем атак по типу с фильтром по атакующему альянсу или игроку.",
      "All alliances": "Все альянсы",
      "All attackers": "Все атакующие",
      "No attacking alliances found": "Атакующие альянсы не найдены",
      "No attackers found": "Атакующие не найдены",
      Reset: "Сбросить",
      Caravan: "Караван",
      Battle: "Бой",
      Ops: "Операции",
      "No attack data matches these filters.": "Нет данных атак для этих фильтров.",
      "Most aggressive alliance": "Самый агрессивный альянс",
      "Most attacked alliance": "Самый атакуемый альянс",
      "No attack data yet": "Данных атак пока нет",
      "No defender alliance data yet": "Данных по альянсам защитников пока нет",
      "Top 10 attackers": "Топ-10 атакующих",
      "Top attacking alliances": "Главные атакующие альянсы",
      "Unique Attackers": "Уникальные атакующие",
      "Total Attacks": "Всего атак",
      "Most attacked alliances": "Самые атакуемые альянсы",
      "Enemy Alliances": "Вражеские альянсы",
      "Top alliance matchups": "Главные пары альянсов",
      "Deleted records": "Удаленные записи",
      Password: "Пароль",
      Review: "Просмотр",
      "Deleted attack log": "Журнал удаленных атак",
      Deleted: "Удалено",
      "Original time": "Исходное время",
      "View image": "Открыть изображение",
      "Server 78 alliances": "Альянсы сервера 78",
      Manage: "Управлять",
      Status: "Статус",
      Remove: "Удалить",
      "Managed alliance list": "Список управляемых альянсов",
      "Field manual": "Полевое руководство",
      "User Manual": "Руководство пользователя",
      "Daily workflow": "Ежедневный процесс",
      Uploads: "Загрузки",
      "Manual records": "Ручные записи",
      "Deletes and retention": "Удаления и хранение",
      "Discord bot": "Discord-бот",
      "Discord scans": "Сканы Discord",
      "Discord queries": "Запросы Discord",
      "Discord troubleshooting": "Диагностика Discord",
      "No defender parsed": "Защитник не распознан",
      "No submitted image is available for this record.": "Для этой записи нет отправленного изображения.",
      "Data management": "Управление данными",
      "Search attacks": "Поиск атак",
      "Duplicate players": "Дубли игроков",
      "Potential parser-name matches": "Возможные совпадения имен парсера",
      "Correct name": "Правильное имя",
      "Merge": "Объединить",
      "Merge duplicates": "Объединить дубли",
      "Active": "Активно",
      "Deleted": "Удалено",
      "Enter delete password": "Введите пароль удаления",
      "Delete this attack?": "Удалить эту атаку?",
      "Remove this alliance from the server 78 list?": "Удалить этот альянс из списка сервера 78?",
    },
  };
  ...
  const manualTranslations = {
    ...
    ru: {
      "Use the dashboard to upload a battle report, covert ops screenshot, or caravan attack screenshot.": "Используйте панель, чтобы загружать боевые отчеты, скриншоты тайных операций или атаки караванов.",
      "Leave server ID blank to use the parser result, or enter the server manually.": "Оставьте ID сервера пустым, чтобы использовать результат парсера, или введите сервер вручную.",
      "The default year is the current calendar year and helps when screenshots only show month and day.": "Год по умолчанию - текущий календарный год; это помогает, когда на скриншоте есть только месяц и день.",
      "Review parsed records in Recent attacks, Players, Stats, and Alliances.": "Проверяйте распознанные записи в разделах Недавние атаки, Игроки, Статистика и Альянсы.",
      "Battle reports track attacker, defender, alliances, server, and event time.": "Боевые отчеты сохраняют атакующего, защитника, альянсы, сервер и время события.",
      "The same image cannot be submitted twice while it is active.": "Одно и то же изображение нельзя отправить дважды, пока запись активна.",
      "Click a record ID to view the submitted image and parsed details.": "Нажмите ID записи, чтобы открыть изображение и распознанные данные.",
      "Covert ops reports track the red attacker entries from the report image.": "Отчеты тайных операций отслеживают красные записи атакующих на изображении.",
      "For covert ops uploads, optionally enter a victim alliance so ops events count against that alliance in stats.": "Для тайных операций можно указать альянс жертвы, чтобы события учитывались против него в статистике.",
      "Caravan attack reports track the top caravan owner as the victim and the dated battle-history entries as attackers.": "Отчеты атак караванов используют владельца каравана как жертву, а записи истории боев с датами как атакующих.",
      "Caravan names can be in English, Spanish, Cyrillic, or other OCR-readable scripts.": "Имена караванов могут быть на английском, испанском, кириллице или других письменностях, читаемых OCR.",
      "Non-English parsing works best when the matching Tesseract language pack is installed on the server.": "Распознавание неанглийского текста работает лучше, если на сервере установлен соответствующий языковой пакет Tesseract.",
      "Manual records are added from": "Ручные записи добавляются из",
      "An image is required even when entering record details by hand.": "Изображение требуется даже при ручном вводе данных записи.",
      "Alliance tags come from the portion of the player name inside brackets.": "Теги альянса берутся из части имени игрока в квадратных скобках.",
      "Example:": "Пример:",
      "records alliance": "записывает альянс",
      "The": "Страница",
      "page shows attack volume, attacks received, member activity, and matchups.": "показывает объем атак, полученные атаки, активность участников и пары альянсов.",
      "Managed Server 78 alliances display green.": "Управляемые альянсы сервера 78 отображаются зеленым.",
      "Other alliances display red.": "Остальные альянсы отображаются красным.",
      "Manage the hidden Server 78 alliance list at": "Управляйте скрытым списком альянсов сервера 78 в",
      "Deleting a record asks for the moderator password.": "При удалении записи запрашивается пароль модератора.",
      "The current delete password is": "Текущий пароль удаления:",
      "Deleted records are soft-deleted, so the database row and image are retained.": "Удаленные записи скрываются логически, поэтому строка базы данных и изображение сохраняются.",
      "Records older than 30 days are automatically soft-deleted on app startup.": "Записи старше 30 дней автоматически скрываются при запуске приложения.",
      "Review deleted records at": "Просматривайте удаленные записи в",
      "Invite the bot to your Discord server from the Discord Developer Portal using the application's OAuth2 bot invite URL.": "Пригласите бота на сервер Discord из Developer Portal через OAuth2 URL приглашения приложения.",
      "Enable Message Content Intent for the bot in the Discord Developer Portal.": "Включите Message Content Intent для бота в Discord Developer Portal.",
      "Start the bot with": "Запустите бота с",
      "set to the bot token, not the application ID or public key.": "установленным в токен бота, а не ID приложения или публичный ключ.",
      "if most scans should default to Server 78.": "если большинство сканов должно по умолчанию использовать сервер 78.",
      "Use": "Используйте",
      "to check whether the bot is online. It should reply with": "чтобы проверить, что бот онлайн. Он должен ответить",
      "Mention the bot and attach one or more screenshots.": "Упомяните бота и прикрепите один или несколько скриншотов.",
      "to process the image as a battle report.": "чтобы обработать изображение как боевой отчет.",
      "to process the image as a covert ops report.": "чтобы обработать изображение как отчет тайной операции.",
      "to process the image as a caravan attack report.": "чтобы обработать изображение как отчет атаки каравана.",
      "with a battle screenshot attached.": "с прикрепленным скриншотом боя.",
      "with a covert ops screenshot attached.": "с прикрепленным скриншотом тайной операции.",
      "with a caravan attack screenshot attached.": "с прикрепленным скриншотом атаки каравана.",
      "For ops scans, the victim alliance can be written as": "Для сканов операций альянс жертвы можно указать как",
      "or": "или",
      "If no parser type is included, the bot tries to auto-detect the screenshot type.": "Если тип парсера не указан, бот пытается определить тип скриншота автоматически.",
      "Duplicate images are rejected the same way they are in the web dashboard.": "Дубли изображений отклоняются так же, как в веб-панели.",
      "to show top attackers, top attacking alliances, and most attacked alliances.": "чтобы показать главных атакующих, атакующие альянсы и самые атакуемые альянсы.",
      "to show recent records.": "чтобы показать недавние записи.",
      "to show a player's recent attack history.": "чтобы показать недавнюю историю атак игрока.",
      "to show Discord image scan options.": "чтобы показать параметры сканирования изображений Discord.",
      "to filter commands to a specific server.": "чтобы фильтровать команды по конкретному серверу.",
      "to recent/history commands to control how many rows are shown.": "к командам recent/history, чтобы управлять количеством строк.",
      "The dashboard alias also works:": "Псевдоним панели тоже работает:",
      "does not respond, make sure the bot process is running.": "не отвечает - убедитесь, что процесс бота запущен.",
      "If mention commands do not work, confirm Message Content Intent is enabled.": "Если команды через упоминание не работают, проверьте, что включен Message Content Intent.",
      "If the bot cannot reply, check channel permissions for view channel, read message history, and send messages.": "Если бот не может отвечать, проверьте права канала: просмотр канала, чтение истории и отправка сообщений.",
      "If web records and Discord records do not match, make sure both are using the same SQLite database path.": "Если записи веба и Discord не совпадают, убедитесь, что оба используют один и тот же путь к SQLite.",
      "For public Discord interactions webhooks, Discord requires an HTTPS interactions URL.": "Для публичных Discord interaction webhooks нужен HTTPS URL.",
      "These records are hidden from normal dashboards and stats. Images remain stored, but their upload hashes were released when the record was deleted.": "Эти записи скрыты из обычных панелей и статистики. Изображения сохраняются, но хэши загрузок освобождаются при удалении записи.",
      "Alliances on this list render green. Any alliance not listed renders red.": "Альянсы в этом списке отображаются зеленым. Любой отсутствующий альянс отображается красным.",
      "Alliance tag, for example AVL": "Тег альянса, например AVL",
    },
  };
  ...
  function translateText(value, lang) {
    ...
    const dynamicPatterns = [
      [/^(\d+) attacks from (\d+) member\(s\)$/, { fr: "$1 attaques par $2 membre(s)", es: "$1 ataques de $2 miembro(s)", pt: "$1 ataques de $2 membro(s)", ru: "$1 атак от $2 участник(ов)" }],
      [/^(\d+) attacks against (\d+) member\(s\)$/, { fr: "$1 attaques contre $2 membre(s)", es: "$1 ataques contra $2 miembro(s)", pt: "$1 ataques contra $2 membro(s)", ru: "$1 атак против $2 участник(ов)" }],
      [/^Server: (.+)$/, { fr: "Serveur : $1", es: "Servidor: $1", pt: "Servidor: $1", ru: "Сервер: $1" }],
    ];
